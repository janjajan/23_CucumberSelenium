...
public class BrowserUtils {
    ...
    public static String captureScreenshot() throws IOException {
        ...
        // Define the file name and path for saving the screenshot
        String screenshotName = "screenshot_" + date + ".png";
        String targetPath = System.getProperty("user.dir") + "/test-output/Screenshots/" + screenshotName;

        // Take the screenshot as both a file and Base64
        TakesScreenshot ts = (TakesScreenshot) Driver.get();
        String base64Screenshot = ts.getScreenshotAs(OutputType.BASE64); // Capture Base64

        // Save the screenshot as a file
        File source = ts.getScreenshotAs(OutputType.FILE); // Capture as a file
